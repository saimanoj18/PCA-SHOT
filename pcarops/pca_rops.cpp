...
int main()
{
    ...
    pcl::concatenateFields (cb.cloud2, cb.cloud2_normals, *cloud_with_normals);
...
*/
    ...
    /*
    ofstream rops_distribution;
    rops_distribution.open ("/home/sai/pcl_testing/pca_shot/PCA_matrices/rops_distribution_cloud0077_0.02_0.10.txt", ios::out | ios::app);

    for (int i = 0; i < cb.histograms2.size(); i++)
    {
        for (int j = 0; j < 135; j++)
        {
            rops_distribution << cb.histograms2[i].histogram[j] << "  ";
        }
        rops_distribution << "\n";
    }
*/
    ...
    Eigen::MatrixXf T;
    T = readMatrix("/home/sai/pcl_testing/pca_shot/PCA_matrices/PCA_for_ROPS_cloud77.txt");
    ...
    std::cout << "Time taken for PCA-RoPS NN Matching : " << (double)cpu_time_used2 << std::endl;
